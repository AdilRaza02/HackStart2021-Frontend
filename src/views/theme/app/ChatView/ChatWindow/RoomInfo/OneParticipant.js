...
const useStyles = makeStyles(theme => ({
  root: {},
  item: { display: 'flex', margin: theme.spacing(1.5, 0) },
  itemIcon: {
    width: 16,
    height: 16,
    marginTop: 4,
  ...
  itemText: { flexGrow: 1, maxWidth: 160, wordWrap: 'break-word' },
  button: {
...
function OneParticipant({
  ...
  return (
    <div className={clsx(classes.root, className)} {...other}>
      ...
      >
        <MAvatar size={96} alt={participant.name} src={participant.avatar} />
