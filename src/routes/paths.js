...
export const PATH_MEDICLY = {
  root: ROOTS.medicly,
  main: {
    photo: path(ROOTS.medicly, '/photo'),
    deficiencies: path(ROOTS.medicly, '/deficiencies'),
    deficiencyDetails: path(ROOTS.medicly, '/deficiencieDetails'),
    articlesResult: path(ROOTS.medicly, '/articleResult')
  }
};
...
export const PATH_LANDINGPAGE = {
  root: '/theme',
  dashboard: '/theme/app/dashboard',
