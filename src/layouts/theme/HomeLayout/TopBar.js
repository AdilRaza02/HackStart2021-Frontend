...
import PopoverMenu from '~/components/theme/PopoverMenu';
import homeFill from '@iconify-icons/eva/home-fill';
import { PATH_HOME, PATH_LANDINGPAGE, PATH_DOCS } from '~/routes/paths';
...
const MENU_LINKS = [
  { title: 'Home', icon: homeFill, href: PATH_LANDINGPAGE.root },
  { title: 'Components', icon: roundStreetview, href: PATH_LANDINGPAGE.components },
  { title: 'Dashboard', icon: roundSpeed, href: PATH_LANDINGPAGE.dashboard },
